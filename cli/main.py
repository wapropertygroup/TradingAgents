...
class MessageBuffer:
    ...
    def _update_current_report(self):
        ...
        if latest_section and latest_content:
            ...
            section_titles = {
                ...
                "earnings_report": "Earnings & Estimate Revisions",
    ...
    def _update_final_report(self):
        ...
        analyst_sections = [
            ...
            "fundamentals_report", "earnings_report",
        ]
        if any(self.report_sections.get(section) for section in analyst_sections):
            ...
            if self.report_sections.get("earnings_report"):
                report_parts.append(
                    f"### Earnings & Estimate Revisions\n"
                    f"{self.report_sections['earnings_report']}"
                )
...
ANALYST_ORDER = ["market", "social", "news", "fundamentals", "earnings"]
ANALYST_AGENT_NAMES = {
    "market": "Market Analyst",
    "social": "Sentiment Analyst",
    "news": "News Analyst",
